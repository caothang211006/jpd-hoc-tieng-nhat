...
(function () {
  ...
  JPD.book({
    ...
    tone: 'gold',
    lessons: [
      { id: 'shochukyu-1',  n: 1,  jp: '新しい一歩',           vi: 'Bước đi mới',              file: null },
      { id: 'shochukyu-2',  n: 2,  jp: '楽しいショッピング',   vi: 'Mua sắm vui vẻ',           file: null },
      { id: 'shochukyu-3',  n: 3,  jp: '私の目標',             vi: 'Mục tiêu của tôi',         file: null },
      { id: 'shochukyu-4',  n: 4,  jp: '住んでいる町',         vi: 'Thành phố đang sống',      file: null },
      { id: 'shochukyu-5',  n: 5,  jp: '大変な１日',           vi: 'Một ngày vất vả',          file: null },
      { id: 'shochukyu-6',  n: 6,  jp: '旅行に行こう',         vi: 'Cùng đi du lịch',          file: null },
      { id: 'shochukyu-7',  n: 7,  jp: '西川さんの家',         vi: 'Nhà anh Nishikawa',        file: null },
      { id: 'shochukyu-8',  n: 8,  jp: 'ありがとう',           vi: 'Cảm ơn',                   file: null },
      { id: 'shochukyu-9',  n: 9,  jp: 'アルバイト先で',       vi: 'Ở nơi làm thêm',           file: null },
      { id: 'shochukyu-10', n: 10, jp: '旅行に行って',         vi: 'Đi du lịch về',            file: null },
      { id: 'shochukyu-11', n: 11, jp: '地域社会の中で',       vi: 'Trong cộng đồng địa phương', file: null },
      { id: 'shochukyu-12', n: 12, jp: '私の健康法',           vi: 'Cách giữ sức khỏe của tôi', file: null },
      { id: 'shochukyu-13', n: 13, jp: '親の気持ち・子の気持ち', vi: 'Lòng cha mẹ, lòng con cái', file: null },
      { id: 'shochukyu-14', n: 14, jp: 'イベント・行事',       vi: 'Sự kiện & lễ hội',         file: null },
      { id: 'shochukyu-15', n: 15, jp: '気になるニュース',     vi: 'Tin tức đáng chú ý',       file: null }
    ]
  });
